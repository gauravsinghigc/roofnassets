...
define("REC_URL", DOMAIN . "/rec");
define("LOGOUT_URL", DOMAIN . "/auth/logout");
...
define("WEEKLY_OFF_DAY_OF_THE_MONTH", CONFIG("WEEKLY_OFF_DAY_OF_THE_MONTH"));
