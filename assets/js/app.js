...
//button animations
function ButtonAnimation(BtnID, AnimationText, FormId = null) {
  function validateForm(FormId) {
    var inputs = document.querySelectorAll(FormId);
  ...
  if (FormId != null) {
    var FormFilledStatus = validateForm(FormId);
    if (FormFilledStatus == true) {
