 <div class="card-body">
     ...
     <div class="row">
         <div class="col-md-3 col-sm-6 col-6">
             <div class="card p-2">
                 <h1><?php echo TOTAL("SELECT UserAppraisalMainUserId FROM user_appraisals where UserAppraisalMainUserId='" . LOGIN_UserId . "'"); ?></h1>
                 <p class="text-gray">All Appraisals</p>
             </div>
         </div>
         <div class="col-md-3 col-sm-6 col-6">
             <div class="card p-2">
                 <h1><?php echo TOTAL("SELECT UserAppraisalMainUserId FROM user_appraisals where UserAppraisalMainUserId='" . LOGIN_UserId . "' and DATE(UserAppraisalDate)='" . date('Y-m-d') . "'"); ?></h1>
                 <p class="text-gray">Today Appraisals</p>
             </div>
         </div>
         <div class="col-md-3 col-sm-6 col-6">
             <div class="card p-2">
                 <h1><?php echo TOTAL("SELECT UserAppraisalMainUserId FROM user_appraisals where UserAppraisalMainUserId='" . LOGIN_UserId . "' and YEAR(UserAppraisalDate)='" . date('Y') . "' and MONTH(UserAppraisalDate)='" . date('m') . "'"); ?></h1>
                 <p class="text-gray">Current Month Appraisals</p>
             </div>
         </div>
         <div class="col-md-3 col-sm-6 col-6">
             <div class="card p-2">
                 <h1><?php echo TOTAL("SELECT UserAppraisalMainUserId FROM user_appraisals where UserAppraisalMainUserId='" . LOGIN_UserId . "' and YEAR(UserAppraisalDate)='" . date('Y') . "'"); ?></h1>
     ...
     <div class="row">
         ...
         <?php
            ...
            if (isset($_GET['UserAppraisalName'])) {
                $TotalItems = TOTAL("SELECT UserAppraisalMainUserId FROM user_appraisals where UserAppraisalMainUserId='" . LOGIN_UserId . "' and UserAppraisalName like '%" . $_GET['UserAppraisalName'] . "%' ORDER by DATE(UserAppraisalDate) DESC");
            } else {
                $TotalItems = TOTAL("SELECT UserAppraisalMainUserId FROM user_appraisals where UserAppraisalMainUserId='" . LOGIN_UserId . "' ORDER by DATE(UserAppraisalDate) DESC limit $start, $end");
            }
         ...
         <?php
            ...
            echo PaginationFooter($TotalItems, "index.php"); ?>
     </div>
 </div>