                                                        ...
                                                        <div class="card card-body rounded-3 p-4">
                                                            <div class="flex-s-b">
                                                                <h4 class="count mb-0 m-t-5 text-primary">
                                                                    <?php echo TOTAL("SELECT OdFormId FROM od_forms where MONTH(OdRequestDate)='$Month' and YEAR(OdRequestDate)='$Year' and OdTeamLeaderId='" . LOGIN_UserId . "'"); ?>
                                                                </h4>
                                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <a href="?UserFullName=<?php echo IfRequested("GET", "UserFullName", "", false); ?>&od_status=NEW&OdRequestDate=<?php echo IfRequested("GET", "OdRequestDate", $OdRequestDate, false); ?>">
                                                        <div class="card card-body rounded-3 p-4">
                                                            <div class="flex-s-b">
                                                                <h4 class="count mb-0 m-t-5 text-primary">
                                                                    <?php echo TOTAL("SELECT OdFormId FROM od_forms where MONTH(OdRequestDate)='$Month' and YEAR(OdRequestDate)='$Year' and OdTeamLeaderId='" . LOGIN_UserId . "' and ODFormStatus='NEW'"); ?>
                                                                </h4>
                                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <a href="?UserFullName=<?php echo IfRequested("GET", "UserFullName", "", false); ?>&od_status=APPROVED&OdRequestDate=<?php echo IfRequested("GET", "OdRequestDate", $OdRequestDate, false); ?>">
                                                        <div class="card card-body rounded-3 p-4">
                                                            <div class="flex-s-b">
                                                                <h4 class="count mb-0 m-t-5 text-primary">
                                                                    <?php echo TOTAL("SELECT OdFormId FROM od_forms where MONTH(OdRequestDate)='$Month' and YEAR(OdRequestDate)='$Year' and OdTeamLeaderId='" . LOGIN_UserId . "' and ODFormStatus='APPROVED'"); ?>
                                                                </h4>
                                                            </div>
                                                ...
                                                <div class="col-md-4">
                                                    <a href="?UserFullName=<?php echo IfRequested("GET", "UserFullName", "", false); ?>&od_status=REJECTED&OdRequestDate=<?php echo IfRequested("GET", "OdRequestDate", $OdRequestDate, false); ?>">
                                                        <div class="card card-body rounded-3 p-4">
                                                            <div class="flex-s-b">
                                                                <h4 class="count mb-0 m-t-5 text-primary">
                                                                    <?php echo TOTAL("SELECT OdFormId FROM od_forms where MONTH(OdRequestDate)='$Month' and YEAR(OdRequestDate)='$Year' and OdTeamLeaderId='" . LOGIN_UserId . "' and ODFormStatus='REJECTED'"); ?>
                                                                </h4>
                                                            </div>
                                                    ...
                                                    <form action="" class="row">
                                                        ...
                                                        ?>
                                                            <div class="col-md-12 text-right">
                                                                <a href="team-ods.php" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Clear Filters</a>
                                                            </div>
                                                        <?php
                                                        } ?>
                                                    </form>
