                      ...
                      <form class="row" action="<?php echo CONTROLLER; ?>" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select class="form-control " name="LeadPersonManagedBy">
                            <?php
                            $Users = _DB_COMMAND_("SELECT UserFullName, UserId, UserPhoneNumber FROM users ORDER BY UserFullName ASC", true);
                            foreach ($Users as $User) {
                              ...
                              echo "<option value='" . $User->UserId . "' $selected>" . $User->UserFullName . " @ " . $User->UserPhoneNumber . " - " . FETCH("SELECT UserEmpGroupName FROM user_employment_details where UserMainUserId='" . $User->UserId . "'", "UserEmpGroupName") . "</option>";
                            }
                            ?>
                          </select>
                        </div>
                        ...
                        <div class="col-md-12">
                          ...
                          <a href="../uploaded/data.php" class="btn btn-md btn-default m-t-15"><i class="fa fa-angle-left"></i> View Uploaded Data</a>
                          <button type="submit" name="UploadLeads" class="btn btn-md btn-dark m-t-15 pull-right" id="submitButton"><i class="fa fa-upload"></i> Upload Leads</button>
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          <a href="../../../storage/export/lead-import-formate.csv" download="lead-import-formate.csv" class='btn btn-sm m-t-10 btn-success'><i class='fa fa-download'></i> Download Format</a>
                        </li>
                      </ul>
                    </div>
                  </div>
