    ...
    if ($CheckEntries == null) { ?>
     ...
     <?php  } else {
      ...
      foreach ($GetLeads as $leads) {
        ...
        $LeadsId = FETCH("SELECT LeadsId from leads where LeadsId='$LeadsId'", "LeadsId");
           ...
           <div class='data-list flex-s-b'>
             <div class="w-pr-30 pt-2">
               <span class='text-primary'>
                 <a class="w-100 text-primary" href="details/index.php?LeadsId=<?php echo SECURE(FETCH("SELECT LeadsId from leads where LeadsId='$LeadsId'", "LeadsId"), "e"); ?>">
                   <span class="app-sub-heading">
                     <i class='fa fa-user'></i> <?php echo FETCH("SELECT LeadSalutations from leads where LeadsId='$LeadsId'", "LeadSalutations"); ?>
                     <?php echo LimitText(FETCH("SELECT LeadPersonFullname from leads where LeadsId='$LeadsId'", "LeadPersonFullname"), 0, 37); ?>
                   </span>
                   <br>
                   ...
                   <span class='text-black mt-2'><i class='fa fa-phone text-success'></i>
                     <?php
                      if (FETCH("SELECT LeadPersonPhoneNumber from leads where LeadsId='$LeadsId'", "LeadPersonPhoneNumber") == null) {
                        echo "No-Phone";
                      } else {
                        echo FETCH("SELECT LeadPersonPhoneNumber from leads where LeadsId='$LeadsId'", "LeadPersonPhoneNumber");
                      } ?><br>
                     <span class='text-black'>
                       <i class='fa fa-envelope text-danger'></i>
                       <?php
                        if (FETCH("SELECT LeadPersonEmailId from leads where LeadsId='$LeadsId'", "LeadPersonEmailId") == null) {
                          echo "No-Email";
                        } else {
                          echo FETCH("SELECT LeadPersonEmailId from leads where LeadsId='$LeadsId'", "LeadPersonEmailId");
                        } ?>
                     </span>
                   </span>
                 </a>
             ...
             <div class='w-pr-15 text-right pt-3'>
               <span class='btn btn-xs btn-default m-1'><?php echo FETCH("SELECT LeadPriorityLevel from leads where LeadsId='$LeadsId'", "LeadPriorityLevel"); ?></span><br>
               <span class='btn btn-xs btn-info m-1'><?php echo FETCH("SELECT LeadPersonSource from leads where LeadsId='$LeadsId'", "LeadPersonSource"); ?></span><br>
               <span class="text-gray m-1">Created At </span>
             </div>
             <div class='w-pr-20 pt-3'>
               <span class='btn btn-xs btn-success m-1'><?php echo FETCH("SELECT LeadPersonStatus from leads where LeadsId='$LeadsId'", "LeadPersonStatus"); ?></span><br>
               <span class='btn btn-xs btn-danger m-1'><?php echo FETCH("SELECT LeadPersonSubStatus from leads where LeadsId='$LeadsId'", "LeadPersonSubStatus"); ?></span><br>
               <span class="text-gray m-1">@ <?php echo DATE_FORMATES("d M, Y", FETCH("SELECT LeadPersonCreatedAt from leads where LeadsId='$LeadsId'", "LeadPersonCreatedAt")); ?></span>
             </div>
             ...
             <?php if (LOGIN_UserType == "Admin") { ?>
               <span class="w-20 pt-2 m-1">
                 <div class="shadow-sm p-1">
                   ...
                   <small>
                     <?php echo UserDetails(FETCH("SELECT LeadPersonManagedBy from leads where LeadsId='$LeadsId'", "LeadPersonManagedBy")); ?>
                   </small>
                 </div>
               </span>
             <?php
       ...
       <?php } else { ?>
         <div class='col-md-4 col-12 col-xs-12'>
           <div class="data-list" style="line-height:1rem !important;">
               ...
               <div class='w-pr-100'>
                 <div class="pt-1">
                   <h5 class='mb-1 app-sub-heading bold' style='font-size:1.2rem !important;'>
                     <a class="w-100 text-primary" href="details/index.php?LeadsId=<?php echo SECURE(FETCH("SELECT LeadsId from leads where LeadsId='$LeadsId'", "LeadsId"), "e"); ?>">
                       <?php echo FETCH("SELECT LeadSalutations from leads where LeadsId='$LeadsId'", "LeadSalutations"); ?>
                       <?php echo LimitText(FETCH("SELECT LeadPersonFullname from leads where LeadsId='$LeadsId'", "LeadPersonFullname"), 0, 25); ?>
                     </a>
                   </h5>
                   ...
                   <div class='flex-s-b lead-action mt-2'>
                     <a href="tel:<?php echo FETCH("SELECT LeadPersonPhoneNumber from leads where LeadsId='$LeadsId'", "LeadPersonPhoneNumber"); ?>" onmouseover="GetInstantTime('displayTime_<?php echo $LeadsId; ?>', 'value')" onclick="Databar('Lead_Update_<?php echo $LeadsId; ?>')" class='btn call btn-md btn-default small w-100'> <?php echo FETCH("SELECT LeadPersonPhoneNumber from leads where LeadsId='$LeadsId'", "LeadPersonPhoneNumber"); ?></a>
                   </div>
                 </div>
               </div>
             </div>
             ...
             <span class="w-100">
               <span class='btn btn-xs btn-default m-1'><?php echo FETCH("SELECT LeadPriorityLevel from leads where LeadsId='$LeadsId'", "LeadPriorityLevel"); ?></span>
               <span class='btn btn-xs btn-info m-1'><?php echo FETCH("SELECT LeadPersonSource from leads where LeadsId='$LeadsId'", "LeadPersonSource"); ?></span>
               <span class='btn btn-xs btn-success m-1'><?php echo FETCH("SELECT LeadPersonStatus from leads where LeadsId='$LeadsId'", "LeadPersonStatus"); ?></span>
               <span class='btn btn-xs btn-danger m-1'><?php echo FETCH("SELECT LeadPersonSubStatus from leads where LeadsId='$LeadsId'", "LeadPersonSubStatus"); ?></span>
             </span><br>
                   ...
                   <div class="flex-s-b">
                     <div class="w-100 m-1">
                       <div class='box-shadow p-4'>
                         <h5 class="mb-0">
                           <a href="tel:<?php echo FETCH("SELECT LeadPersonPhoneNumber from leads where LeadsId='$LeadsId'", "LeadPersonPhoneNumber"); ?>">
