...
//pagevariables
$PageName = "GENERAL ENQUIRIES";
$PageDescription = "Manage teams";
$VISIT_TYPE = "GENERAL ENQUIRY";
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="#" onclick="Databar('AddGeneralEnquiry')" class="btn btn-md fs-15 mb-0 m-b-0 btn-danger btn-block">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="data-list header-bg flex-s-b">
                                                ...
                                                <div class="w-pr-12">Visitor Name</div>
                                                <div class="w-pr-10 text-left">Phone Number</div>
                                                <div class="w-pr-15 text-center">Purpose</div>
                                                    ...
                                                    <div class="data-list flex-s-b">
                                                        ...
                                                        <div class="w-pr-15 flex-s-b text-center">
                                                            <?php if ($Visitors->VisitEnquiryStatus == "PENDING") { ?>
                                                                ...
                                                                <button type='button' onclick="Databar('Update_General_Enquiry_<?php echo $ViewAndUpdateFormId; ?>')" class="btn btn-xs btn-view btn-primary">DETAILS</button>
                                                            ...
                                                            <?php } elseif ($Visitors->VisitEnquiryStatus == "COMPLETED") { ?>
                                                                <a href="#" onclick="Databar('Update_General_Enquiry_<?php echo $ViewAndUpdateFormId; ?>')" class="btn btn-xs btn-primary">VIEW DETAILS</a>
                                                            <?php } else { ?>
                                                                <form action='<?php echo CONTROLLER; ?>' method="POST">
                                                                    <?php echo FormPrimaryInputs(true, [
                                                                        "Status" => "COMPLETED"
                                            ...
                                            <?php
                                                    include $Dir . "/include/forms/View-And-Update-General-Enquiry-Records.php";
                                                }
                                            } ?>
                                        </div>
    ...
    <?php
    include $Dir . "/include/forms/Add-New-General-Enquiry.php";
