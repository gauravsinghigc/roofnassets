...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="#" onclick="Databar('AddNewDeliveryRecords')" class="btn btn-md fs-15 mb-0 m-b-0 btn-danger btn-block">
    ...
    <?php
    include $Dir . "/include/forms/Add-New-Delivery.php";
