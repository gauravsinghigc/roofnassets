...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="#" onclick="Databar('AddNewMeetingRecords')" class="btn btn-md fs-15 mb-0 m-b-0 btn-danger btn-block">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="data-list header-bg flex-s-b">
                                                ...
                                                <div class="w-pr-12 text-center">Purpose</div>
                                            ...
                                            $SQL = "SELECT * FROM reception_visitors, reception_meeting where reception_visitors.VisitorId=reception_meeting.reception_meeting_user_main_id and VisitPersonType like '%$VISIT_TYPE%' ORDER BY DATE(VisitPersonCreatedAt) DESC";
                                                ...
                                                foreach ($AllVisitors as $Visitors) {
                                                    ...
                                                    <div class="data-list flex-s-b">
                                                        ...
                                                        <div class="w-pr-12 text-center">
                                                            <?php echo LimitText($Visitors->VisitPurpose, 0, 25); ?>
                                                        </div>
                                                        ...
                                                        <div class="w-pr-15 flex-s-b text-center">
                                                            <?php if ($Visitors->VisitEnquiryStatus == "PENDING") { ?>
                                                                ...
                                                                <button type='button' onclick="Databar('Update_Meeting_Visits_<?php echo $ViewAndUpdateFormId; ?>')" class="btn btn-xs btn-view btn-primary">DETAILS</button>
                                                            <?php } elseif ($Visitors->VisitEnquiryStatus == "REJECTED") { ?>
                                                                <a href="#" onclick="Databar('Update_Meeting_Visits_<?php echo $ViewAndUpdateFormId; ?>')" class="btn btn-xs btn-primary">DETAILS</a>
                                                            <?php } elseif ($Visitors->VisitEnquiryStatus == "COMPLETED") { ?>
                                                                <a href="#" onclick="Databar('Update_Meeting_Visits_<?php echo $ViewAndUpdateFormId; ?>')" class="btn btn-xs btn-primary">VIEW DETAILS</a>
                                                            <?php } else { ?>
                                                                <form action='<?php echo CONTROLLER; ?>' method="POST">
                                                                    <?php echo FormPrimaryInputs(true, [
                                                                        "Status" => "COMPLETED"
                                                                    ]); ?>
                                                                    <button name='UpdateVisitStatus' value='<?php echo SECURE($Visitors->VisitorId, "e"); ?>' class="btn btn-xs btn-warning">MARK COMPLETED</button>
                                                                </form>
                                                                <a href="#" onclick="Databar('Update_General_Enquiry_<?php echo $ViewAndUpdateFormId; ?>')" class="btn btn-xs btn-primary">DETAILS</a>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                            <?php
                                                    include $Dir . "/include/forms/View-And-Update-Meeting-Records.php";
                                                }
                                            } ?>
                                        </div>
    ...
    <?php
    include $Dir . "/include/forms/Add-New-Meeting-Records.php";
