...
<body class="hold-transition sidebar-mini">
                            ...
                            <div class="card card-primary">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <a href="#" onclick="Databar('AddNewITSupport')" class="btn btn-md fs-15 mb-0 m-b-0 btn-danger btn-block">
                                                <i class="fa fa-plus"></i> Add IT <?php echo $VISIT_TYPE; ?>
                                            </a>
                                        </div>
                                    </div>
                                        ...
                                        <div class='col-md-3 col-6'>
                                            <a href="index.php">
                                                <div class="card card-body rounded-3 p-4 shadow-lg">
                                                    ...
                                                    <hr class="mt-1 mb-1">
                                                    <p class="mb-0 fs-14 text-black">All IT <?php echo $VISIT_TYPE; ?> VISITS</p>
                                                </div>
                                            </a>
                                        </div>
                                        <div class='col-md-3 col-6'>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="data-list header-bg flex-s-b">
                                                ...
                                                <div class="w-pr-10 text-center">IN-OUT</div>
                                                ...
                                                foreach ($AllVisitors as $Visitors) {
                                                    ...
                                                    <div class="data-list flex-s-b">
                                                        ...
                                                        <div class="w-pr-12 text-center">
                                                            <?php echo LimitText($Visitors->VisitPurpose, 0, 20); ?>
                                                        </div>
                                                        ...
                                                        <div class="w-pr-15 flex-s-b">
                                                            ...
                                                            <?php } elseif ($Visitors->VisitEnquiryStatus == "COMPLETED") { ?>
                                                                <a href="#" class="btn btn-xs btn-primary">VIEW DETAILS</a>
                                                            <?php } else { ?>
                                                                <form action='<?php echo CONTROLLER; ?>' method="POST">
                                                                    <?php echo FormPrimaryInputs(true, [
                                                                        "Status" => "COMPLETED"
    ...
    <?php
    include $Dir . "/include/forms//Add-New-IT-Support.php";
