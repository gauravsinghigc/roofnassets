...
if (isset($_POST['CreateLeads'])) {
  ...
  if ($FileName[1] == "csv") {
    ...
    while ($data = fgetcsv($handle)) {
      ...
      if (array(null) !== $data) {
        ...
        $Check = CHECK("SELECT LeadsPhone FROM lead_uploads where LeadsPhone='$TrimedPhoneNumber'");
        if ($Check == null) {
  ...
  RESPONSE($Save, "Leads Uploaded successfully. <b>$NET_UPLOADED</b> Uploaded, <b>$DupliCateCount</b> Duplicate Records and <b>$SkipedNumbers</b> numbers skipped!", "Unable to upload data at the moment!");
