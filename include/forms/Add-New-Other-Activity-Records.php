<section class="pop-section hidden" id="AddNewOtherActivityRecord">
    <div class="action-window">
        <div class='container'>
            <div class='row'>
                <div class='col-md-12'>
                    <h4 class='app-heading'>Add New Other Activity Record</h4>
                </div>
            </div>
            <form class="row" action="<?php echo CONTROLLER; ?>" method="POST">
                <?php FormPrimaryInputs(true, [
                    "VisitPersonType" => "OTHERS"
                ]); ?>
                <div class="col-md-5">
                    <h5 class="app-sub-heading">Team/Executive Included, Select Team Person</h5>
                    <div class="row">
                ...
                <div class='col-md-12 text-right'>
                    <a onclick="Databar('AddNewOtherActivityRecord')" class="btn btn-lg btn-default mr-3">Cancel</a>
                    <button type="submit" name="SaveNewOtherActivityRecords" class='btn btn-lg btn-primary'>Save Records <i class='fa fa-check'></i></button>
                </div>
            </form>
        </div>
    </div>
