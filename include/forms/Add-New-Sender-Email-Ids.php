<section class="pop-section hidden" id="AddNewSenderEmailId">
    <div class="action-window">
        <div class='container'>
            <div class='row'>
                <div class='col-md-12'>
                    <h4 class='app-heading'>ADD-NEW SENDER EMAIL-Id</h4>
                </div>
            </div>
            <form class="row" action="<?php echo CONTROLLER; ?>" method="POST">
                ...
                <div class="col-md-5">
                    <p class="small">
                        <code class="h6 bold text-danger">PLEASE READ BEFORE ADDING NEW SENDER EMAIL-id</code><br>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            <h6 class='app-sub-heading'>ADD NEW SENDER EMAIL</h6>
                            <p class="text-secondary mb-10px">enter smtp details for new sender email-id</p>
                        </div>
                        <div class="form-group col-md-12 pb-2">
                            <label>SMTP Hostname *</label>
                            <input type="text" name="config_mail_sender_host" list='config_mail_sender_host' class="form-control" required>
                        ...
                        <div class="form-group col-md-3 pb-2">
                            ...
                            <input type="number" name="config_mail_send_limit" min='1' class="form-control" required>
                        </div>
                    </div>
                </div>

                <div class=" col-md-12 text-right">
                    <button type="submit" name="SAVE_NEW_SENDER_EMAIL_ID" class="btn btn-lg btn-primary"><i class="fa fa-check"></i> SAVE SENDER EMAIL</button>
                    <a href="#" onclick="Databar('AddNewSenderEmailId')" class="btn btn-lg btn-default">Cancel</a>
                </div>
            </form>
        </div>
    </div>
