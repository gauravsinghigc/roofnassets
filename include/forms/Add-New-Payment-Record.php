<section class="pop-section hidden" id="AddNewPaymentActivityRecord">
  <div class="action-window">
    <div class='container'>
      <div class='row'>
        <div class='col-md-12'>
          <h4 class='app-heading'>Add NEW Payment Activity Record</h4>
        </div>
      </div>
      <form class="row" action="<?php echo CONTROLLER; ?>" method="POST">
        <?php FormPrimaryInputs(true, [
          "VisitPersonType" => "PAYMENTS"
        ]); ?>
        <div class="col-md-5">
          <h5 class="app-sub-heading">Payment/Transaction Managed/Executed By</h5>
          <div class="row">
                      ...
                      <div class="flex-s-b">
                        ...
                        <div class="text-left w-pr-90 pl-2">
                          <label class="w-100 lh-0-0-1">
                            <span class="fs-20 bold mt-0 app-text-2"><?php echo $User->UserFullName; ?></span><br>
        ...
        <div class="col-md-7">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-12 form-group mt-1">
              <label class="fs-16">Payment Related To <?php echo $req; ?></label>
              <input type="text" name="VisitPurpose" required class="form-control" placeholder="">
            </div>
            <div class="col-md-12 col-12 form-group mt-1">
            ...
            <div class="col-md-12 col-12 form-group mt-1">
              ...
              <select name='rec_pay_for_project_id' class="form-control" required>
        ...
        <div class='col-md-12 text-right'>
          <a onclick="Databar('AddNewPaymentActivityRecord')" class="btn btn-lg btn-default mr-3">Cancel</a>
          <button type="submit" name="SaveNewPaymentActivityRecords" class='btn btn-lg btn-primary'>Save Records <i class='fa fa-check'></i></button>
        </div>
      </form>
    </div>
  </div>
