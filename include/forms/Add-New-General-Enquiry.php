<section class="pop-section hidden" id="AddGeneralEnquiry">
        ...
        <div class='container'>
            ...
            <form id='VisitorForm' class="row" action="<?php echo CONTROLLER; ?>" method="POST">
                ...
                <div class="col-md-7">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12 form-group mt-1">
                            ...
                            <input type="text" name="VisitPurpose" required class="form-control" placeholder="Purpose of visit">
                        </div>
                ...
                <div class='col-md-12 text-right'>
                    <a onclick="Databar('AddGeneralEnquiry')" class="btn btn-lg btn-default mr-3">Cancel</a>
                    <button type="SUBMIT" name="SaveGeneralEnquiryRecordsNEW" class='btn btn-lg btn-primary'>Save Records <i class='fa fa-check'></i></button>
                </div>
            </form>
        </div>
    </div>
